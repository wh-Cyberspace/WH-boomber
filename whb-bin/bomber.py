...
W='\033[0m'
# The Credit For This Code Goes To SpeedX And All Other Contributors Listed At https://github.com/TheSpeedX/WH-Boom
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        try:
            ...
            if cc == "91":
                print('Sorry All APIs Have Expired Please Update WH-bomber')
...
try:
    noti = urllib.request.urlopen(
        "https://raw.githubusercontent.com/wh-hackerexploit/WH-boomber/master/.whnotefy").read().decode('utf-8')
